...
export const USERS_DATA: User[] = [
  ...
  },
  {
    ...
    roles: [{ id: 'inspektorat', name: 'inspektorat', label: 'Inspektorat', description: 'Inspection and monitoring role' }],
    isActive: true,
  ...
  },
  {
    ...
    roles: [{ id: 'perwadag', name: 'perwadag', label: 'Perwadag', description: 'Trade supervision and regulation role' }],
    perwadagId: 'PWD001',
    isActive: true,
